...
First things first: here is what your heating automation might look like (and yes, the colors carry meaning, for example, one glance suffices to know whether a room is currently heating, in heating demand, or off):
