''' Changelog:
    ...
    - rc34: HeatingPumpControl is only responsible for switching on and off the heat pump and listen to the heating claims. 
            HeatingAutomation, on the other hand, is exclusively responsible for determining the heating claims.
    - rc36: 
    ...
    - rc37: 20260111
        - Fröling Außenfühler has been detached, which makes the boiler default to 0 degrees as outside temp.
          ...
          Finalized interpolation logic in HeatingPumpControl. $T_{neg10}$ fixed at 45.0. Added safety clamp for $T_{pos10}$ at 10.0 (boiler minimum). 
    ...
    - rc39:
        - added listeners: 
          In the HeatingAutomation Class   
          ...
          In the HeatingPumpControl Class
    ...
    - rc46: 20260118
        ...
        - added method check_system_health to HeatingPumpControl + minor adjustments
        - removed method notify from HeatingAutomation
    - rc47: 20260119
